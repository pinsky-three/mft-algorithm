...
class SampleStrategy(IStrategy):
    ...
    def plot_config(self):
        """
        There are a lot of solutions how to build the plot_config
        The one below is used by the strategy author
        Returns a plot configuration for the strategy
        """
        plot_config = {
            'main_plot': {
                'tema': {},
    ...
    def informative_pairs(self):
        ...
        These pairs will not be traded, but are used for informative purposes.
        For more information, please see the documentation for freqtrade.strategy.IStrategy.informative_pairs
        """
        return []
